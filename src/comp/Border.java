...
public class Border implements Drawable {
	...
	public void draw(Graphics2D g) {
		g.setColor(inner);
		if(roundedBorder) {
			g.fillRoundRect(surr.getAbsoluteX(), surr.getAbsoluteY(), surr.getWidth(), surr.getHeight(), 10, 10);
		} else {
		...
		if(roundedBorder) {
			g.drawRoundRect(surr.getAbsoluteX(), surr.getAbsoluteY(), surr.getWidth(), surr.getHeight(), 10, 10);
		} else {

...
public abstract class AbstractArrow extends RangedWeapon {
	...
	/** Methode vergleicht den Übergebenen String mit den ...Arrow.NAME und gibt das jeweilige class-Object zurück ...Arrow.class *
	 *  @see <code> reformArrow(int selectedArrowIndex) </code>*/

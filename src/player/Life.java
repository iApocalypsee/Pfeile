...
public class Life {
	...
	/** KONSTRUCKTOR: zuerst allgemein: bei 'type = TYPE_PLAYER': Initialieserung f�r speziel f�r Spieler 
	 * @version 1.2 */
	public Life () {
		...
		/* Konstrucktoraufruf f�r den Player */
//		if(!player.isBot()) {
//			// INITIALISIERUNG
//
...
//		}
	...
	/** nach jeden Zug aufrufen, um die neuen Werte f�r Leben und Darstellung des Leben zu berechnen */ 
	...
	/** GETTER: gibt das Rectangle 'boundingLife' zur�ck; z.B. f�r GUI-Darstellung notwendig (v.a. da auf ein BufferedImage verzichtet wurde) */

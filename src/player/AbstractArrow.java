...
public abstract class AbstractArrow extends RangedWeapon {
	...
	// TODO
	// alle Werte die auf 25m gerechnet werden müssen, müssen noch von 100m auf
...
// this.posX = gui.Field.getPosXFromFieldNr (fieldNr);
// this.posY = gui.Field.getPosYFromFieldNr (fieldNr);
// }
// --> arrowSpeed
// --> acceleration
// --> damageRadius

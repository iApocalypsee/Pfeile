...
class Soundtrack(override val from: URI, lineClass: Class[_]) extends SoundtrackLike {
  ...
  /** Constructs a soundtrack from a file object. */
  def this(file: java.io.File) = this( file.toURI )

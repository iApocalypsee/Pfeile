...
public class PreWindow extends JFrame {
	...
	public PreWindow(int width, int height, int type, String heading) {
		...
		if (type == 0) {
			...
			this.label0 = new JLabel("Computerstärke: "); // "Computerst�rke"
			this.label1 = new JLabel("Pfeilanzahl [frei wählbar]: "); // "Pfeilanzahl [frei w�hlbar]"
			this.label2 = new JLabel("Pfeilanzahl [vorher wählbar]: "); // "Pfeilanzahl [vorher w�hlbar]"
			...
			this.label8 = new JLabel("Weltgröße: "); // "Weltgr��e"
	...
	class ListenToButton implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			// ~~~~~~~~~~~~~
				...
				if (Mechanics.KI == -1) {
					PreWindow.this.warningMessage = ("Select unselected Selections: KI-Stärke");
					JOptionPane.showMessageDialog(PreWindow.this,

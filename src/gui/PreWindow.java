	...
	class ListenToButton implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			// ~~~~~~~~~~~~~
				...
				if (Mechanics.KI == -1) {
					PreWindow.this.warningMessage = ("Select unselected Selections: KI-StÃ¤rke");
					JOptionPane.showMessageDialog(PreWindow.this,
...
//				isReady = true;
			...
			// diese im Label an
				...
				Mechanics.KI = 2;
				PreWindow.this.label0.setText("ComputerstÃ¤rke: " + "mittel");
				
				Mechanics.arrowNumberFreeSet = 5;
				PreWindow.this.label1.setText("Pfeilanzahl [frei wÃ¤hlbar]: "
						+ Mechanics.arrowNumberFreeSet);
				
				Mechanics.arrowNumberPreSet = 10;
				
				PreWindow.this.label2.setText("Pfeilanzahl [vorher wÃ¤hlbar]: "

...
public class FieldInfoBox extends Component {
	...
	public FieldInfoBox() {
		// standardm��ig ist der GameScreen f�r diese Component zust�ndig
		...
		setWidth(Component.getTextBounds("Feldtyp: H�gelebene", Component.STD_FONT).width + 10);
		setHeight(Component.getTextBounds("Feldtyp: H�gelebene", Component.STD_FONT).height * 2 + 15);
	}
	...
	void retrieveData(Field field) {
		...
		// TODO wenn noch weitere Informationen bezogen werden k�nnen, diese auch hineinschreiben
	}
	...
	public void draw(Graphics2D g) {
		...
		g.drawString("Zug�nglich: " + queriedIsAccessible, Main.getWindowWidth() - insetX + 10, Main.getWindowHeight() - insetY + 18 + 18);
	}
